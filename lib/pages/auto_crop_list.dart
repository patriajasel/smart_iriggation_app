            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListTile(
                    leading: const Icon(
                      ...
                      color:
                          Colors.green, // Uncomment and choose a color if needed
                    ),
                    title: const Text(
                      "Type of Soil:",
                      style: TextStyle(
                ...
                Container(
                  ...
                  // Show two buttons if dataReceived is "Unidentified"
                  Center(
                    child: Column(
                      children: [
                        SizedBox(
                  ...
                  // Show crop list if dataReceived is not "Unidentified"
                  Container(
                  padding: const EdgeInsets.all(8.0),
                  child: const Text(
